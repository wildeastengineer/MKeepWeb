import { ProfileRepository } from 'warehouse/repositories';
...
export function changeProfileLanguage(language, cookies) {
    return (dispatch) => {
        const profileRepository = new ProfileRepository(cookies);
...
/* Get user profile */
export function getUserProfile(cookies) {
    return (dispatch) => {
